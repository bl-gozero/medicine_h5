...
export default {
	goodsList(data = {}, config = {}) {
		return request.post('/goods/list', { is_integral: 2, is_lucky_star: 2, ...data }, { ...config })
	},
	goodsDetail(data) {
	...
	orderPay(data = {}, config = {}) {
		return request.post('/order_form/paying', { device: 2, ...data }, { loading: true, ...config })
	},
	orderCancel(data) {
