<template>
	<view class="page bg-page">
		...
		<view class="pt-10 mlr-20 relative" style="z-index: 2;">
			<image src="/static/index/task_top.webp" class="absolute top-20 right-0 w-179 h-118" style="transform: translateY(-30%);"></image>
			...
			<view
				class="bg-white rounded-12 ptb-20 plr-16 mt-20 relative"
		...
		<!-- 提示弹窗 -->
		<u-popup :show="showInfo" mode="center" bgColor="transparent" :closeOnClickOverlay="false" @close="showInfo = false;">
			<view class="w-308 h-303 rounded-20 p-25 border-box bg-white">
				...
				<u-button
					class="bg-base bold fs-16 flex-center text-white w-234 h-51 mt-34"
					shape="circle"
	...
	export default {
		...
		data() {
			return {
				...
				list: [
					{ id: 1, name: '135元北朝鲜山参', img: '/static/task/task_new.webp', text: '免费领', url: '/pages/activity/newExclusive', is_new: true },
					{ id: 2, name: '每月领一箱鸡蛋', img: '/static/task/task_egg.webp', text: '做任务', url: '/pages/activity/egg', is_new: false },
					{ id: 3, name: '邀好友得现金', img: '/static/task/task_invite.webp', text: '去邀请', url: '/pages/user/qrcode', is_new: false },
				],
				tasks: [],
				doSign: null,
				reward: 0,
