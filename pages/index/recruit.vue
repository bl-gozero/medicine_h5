<template>
	<view class="page">
		...
		<u-popup :show="showFail" mode="center" bgColor="transparent" :closeOnClickOverlay="false"
			@close="showFail = false;">
			<view class="w-308 h-280 sign_reward_box rounded-20 text-center">
				<image :src="$c.img('/static/index/recruit/info.webp')" class="i-101 auto-x" style="margin-top: -50px;">
				</image>
				...
				<button class="bg-base bold fs-16 flex-center text-white w-234 h-51 rounded-x mt-33"
					@click="showFail = false;">知道了</button>
			</view>
		</u-popup>
	</view>
</template>
