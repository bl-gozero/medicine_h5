<template>
	<view class="page bg-page">
		...
		<view class="plr-20">
			<view class="bg-white plr-15 ptb-14 flex-between rounded-8 mt-12" @click="chooseAvatar()">
				...
				<view class="flex-start">
					<u-avatar :src="form.icon" size="39" default-url="/static/group/default.png" class="mr-9" mode="aspectFill"></u-avatar>
		...
		<view class="fixed left-0 bottom-0 pw-100 ptb-20">
			<u-button
				class="fw-7 lh-10 fs-14 bg-base text-white w-247 h-47 flex-center"
				shape="circle"
				@click="doSubmit"
			>创建</u-button>
...
<script>
	...
	export default {
		...
		data() {
			return {
				form: { icon: '', name: '', intro: '', team_category: 2, join_mode: 0, join_text: '无需验证' },
				showPicker: false,
				columns: [
					[{ id: 0, name:'无需验证' },
					{ id: 1, name:'群主或管理员验证' },
