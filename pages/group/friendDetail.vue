<template>
	<view class="page bg-page plr-20">
		...
		<view class=" plr-15 ptb-14 bg-white flex-between mt-12 rounded-8">
			<u-avatar :src="$c.formatImgUrl(friendInfo.avatar)" size="47" :default-url="$c.userAvatar()"
		...
		<view class="plr-15 bg-white mt-12 rounded-8 list_box">
			<view class="flex-between ptb-18">
				...
				<u-switch v-model="friendInfo.isBlocked" :activeColor="$c.baseColor()" inactiveColor="#DFDFDF"
					:activeValue="true" :inactiveValue="false" size="20" asyncChange @change="onBlack"></u-switch>
			</view>
		</view>
