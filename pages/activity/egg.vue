			...
			<view class="flex-center">
				<view class="relative">
					...
					<view class="full plr-20 border-box">
						<view v-if="list.length" class="mt-6 flex-between plr-4 ptb-6 border-box rounded-8" style="background: #E8F1FC;" v-for="(item, i) in list" :key="item.datetime">
						...
						<view v-else class="mt-6 flex-between plr-4 ptb-6 border-box rounded-8" style="background: #E8F1FC;" v-for="(item, i) in 12" :key="i">
							<view class="i-47 bg-white rounded-8 flex-center">
								<image src="/static/avtivity/egg/egg.webp" class="w-37 h-25"></image>
							</view>
							<view class="flex-1 mlr-4">
							...
							<image src="/static/avtivity/egg/btn-3.webp" class="w-95 h-54" @click="onAddress(item, i)"></image>
						</view>
					</view>
				</view>
			</view>
