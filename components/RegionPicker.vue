<template>
	<view>
		<u--text suffixIcon="arrow-right" iconStyle="font-size: 10px;color: #9F9F9F" size="14" lineHeight="14"
			:color="value ? '#3D3D3D' : '#9F9F9F'" :text="displayText || '请填写省市区街道'" @click="showPicker = true"></u--text>

		<u-picker :show="showPicker" mode="multi-column" keyName="label" :columns="columns" :confirmColor="$c.baseColor()" @change="onPickerChange"
